...
public class WordCounter {
    public static void main(String[] args) {
        String sentences = "When the offensive resumed, the Turks received their first victory when the Greeks encountered stiff resistance in the battles of First and Second İnönü,"
        ...
        String[] words = sentences.toLowerCase().replaceAll("[.,!?\"]","").split("\\s+");
